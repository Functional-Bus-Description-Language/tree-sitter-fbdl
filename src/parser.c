...
enum {
  ...
  sym_single_line_instantiation = 61,
  sym_multi_line_instantiation = 62,
  ...
  aux_sym_multi_import_statement_repeat1 = 75,
  aux_sym_multi_constant_definition_repeat1 = 76,
  aux_sym__parameters_repeat1 = 77,
  aux_sym_element_body_repeat1 = 78,
  aux_sym_multi_property_assignment_repeat1 = 79,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_single_line_instantiation] = STATE(32),
    [sym_multi_line_instantiation] = STATE(32),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(170)] = 3783,
  [SMALL_STATE(171)] = 3796,
  [SMALL_STATE(172)] = 3809,
  [SMALL_STATE(173)] = 3822,
  [SMALL_STATE(174)] = 3835,
  [SMALL_STATE(175)] = 3848,
  [SMALL_STATE(176)] = 3861,
  [SMALL_STATE(177)] = 3874,
  [SMALL_STATE(178)] = 3887,
  [SMALL_STATE(179)] = 3900,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [51] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_description_repeat1, 2), SHIFT_REPEAT(128),
  [54] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_description_repeat1, 2), SHIFT_REPEAT(120),
  [57] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_description_repeat1, 2), SHIFT_REPEAT(199),
  [60] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_description_repeat1, 2), SHIFT_REPEAT(243),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_description, 1),
  [65] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_element_body_repeat1, 2), SHIFT_REPEAT(95),
  [68] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_element_body_repeat1, 2), SHIFT_REPEAT(198),
  [71] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_element_body_repeat1, 2), SHIFT_REPEAT(246),
  ...
  [80] = {.entry = {.count = 1, .reusable = false}}, SHIFT(246),
  [82] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [84] = {.entry = {.count = 1, .reusable = true}}, SHIFT(131),
  [86] = {.entry = {.count = 1, .reusable = true}}, SHIFT(239),
  ...
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_operation, 3),
  ...
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 5),
  [124] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call, 5),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 4),
  [128] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call, 4),
  ...
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subscript, 4),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subscript, 4),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 3),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 3),
  ...
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_single_line_type_definition, 4),
  [168] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_single_line_type_definition, 4),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_single_line_type_definition, 5),
  [172] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_single_line_type_definition, 5),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_single_line_instantiation, 6),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_single_line_instantiation, 6),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_single_line_instantiation, 3),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_single_line_instantiation, 3),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_single_line_instantiation, 7),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_single_line_instantiation, 7),
  ...
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multi_line_instantiation, 4),
  [198] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_multi_line_instantiation, 4),
  [200] = {.entry = {.count = 1, .reusable = true}}, SHIFT(160),
  [202] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_single_line_instantiation, 8),
  [206] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_single_line_instantiation, 8),
  [208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_single_line_type_definition, 7),
  [210] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_single_line_type_definition, 7),
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multi_line_instantiation, 7),
  [214] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_multi_line_instantiation, 7),
  ...
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multi_line_type_definition, 6),
  [232] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_multi_line_type_definition, 6),
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multi_line_instantiation, 3),
  [236] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_multi_line_instantiation, 3),
  ...
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_single_import_statement, 4),
  [250] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_single_import_statement, 4),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multi_line_type_definition, 5),
  [254] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_multi_line_type_definition, 5),
  ...
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multi_line_instantiation, 6),
  [276] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_multi_line_instantiation, 6),
  [278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_single_line_instantiation, 5),
  [280] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_single_line_instantiation, 5),
  ...
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multi_import_statement, 5),
  [292] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_multi_import_statement, 5),
  [294] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_multi_import_statement_repeat1, 2), SHIFT_REPEAT(212),
  [297] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_multi_import_statement_repeat1, 2), SHIFT_REPEAT(227),
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_multi_import_statement_repeat1, 2),
  ...
  [322] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_repeat1, 2), SHIFT_REPEAT(16),
  ...
  [341] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_multi_property_assignment_repeat1, 2), SHIFT_REPEAT(210),
  [344] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_multi_property_assignment_repeat1, 2),
  [346] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_multi_import_statement_repeat1, 3),
  [348] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [350] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__arguments, 2),
  [352] = {.entry = {.count = 1, .reusable = true}}, SHIFT(207),
  [354] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameters, 2),
  [356] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__parameters_repeat1, 2), SHIFT_REPEAT(207),
  [359] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__parameters_repeat1, 2),
  [361] = {.entry = {.count = 1, .reusable = true}}, SHIFT(223),
  [363] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [365] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expressions, 2),
  [367] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_list, 3),
  ...
  [375] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameters, 1),
  [377] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameter, 1),
  ...
  [403] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expressions, 1),
  ...
  [411] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_list, 2),
  [413] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_multi_constant_definition_repeat1, 2), SHIFT_REPEAT(230),
  [416] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_multi_constant_definition_repeat1, 2),
  ...
  [424] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__arguments_repeat1, 2), SHIFT_REPEAT(5),
  [427] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__arguments_repeat1, 2),
  ...
  [435] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameter, 3),
  ...
  [447] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__argument, 3),
  [449] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__property_assignment, 3),
  [451] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_multi_constant_definition_repeat1, 4),
  [453] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument_list, 2),
  ...
  [479] = {.entry = {.count = 1, .reusable = false}}, SHIFT(251),
