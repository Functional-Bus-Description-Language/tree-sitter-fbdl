...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [232] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(123),
  ...
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 1),
  ...
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 3),
  ...
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments_list, 3),
  ...
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters_list, 2),
  ...
  [352] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments_list, 2),
  [354] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters_list, 3),
